...
class CompanyComparisonEngine:
    ...
    async def compare(cls, ticker1: str, ticker2: str, llm) -> str:
        ...
        prompt = (
            ...
            "4. DO NOT act like a news reader. DO NOT list headlines. Instead, synthesize the 'Latest' section into a cohesive 1-2 sentence intelligence summary.\n"
            ...
            f"{name2} → {biz2}\n\n"
            "📰 Latest\n"
            "[1-2 sentence intelligence synthesis of the recent headlines for both companies. If none, state 'No breaking catalysts verified today.']\n\n"
            "🌐 Industry\n"
