...
class MarketMovementAnalyzer:
    ...
    async def analyze_movement(cls, symbol: str, llm) -> str:
        ...
        prompt = (
            ...
            "5. DO NOT act like a news reader. DO NOT list headlines. Instead, synthesize recent data into a highly informative 'Strategic Context' summary that explains the fundamental drivers and broader context to the user.\n"
