...
class MarketMovementAnalyzer:
    ...
    async def analyze_movement(cls, symbol: str, llm) -> str:
        ...
        prompt = (
            ...
            "5. DO NOT act like a news reader. DO NOT list headlines. Instead, synthesize the recent headlines into a cohesive 1-2 sentence intelligence summary.\n"
            "6. CLEAN TELEGRAM LAYOUT: Follow the EXACT template below.\n\n"
            ...
            f"Volume: {vol_str}\n\n"
            "📰 Key Developments\n\n"
            "[1-2 sentence intelligence synthesis of the recent headlines. If none, state 'No breaking catalysts verified today.']\n\n"
            "💡 What Matters\n"
