...
class DeepResearchEngine:
    ...
    async def _synthesize_public_deep_dive(
        ...
        prompt = (
            ...
            "CRITICAL FORMATTING RULE: DO NOT act like a news reader. Do not list headlines. Synthesize recent data into a highly informative 'Strategic Context' summary that explains the fundamental drivers and broader context to the user.\n\n"
            "FORMAT:\n\n"
            ...
            "📌 Strategic Context\n"
            "[Synthesize recent data into a 1-2 sentence deep, informative analysis of the underlying fundamental drivers affecting the company right now. Focus on the 'why' and the actionable intelligence. If none, state 'No breaking catalysts verified in the last 24h.']\n\n"
