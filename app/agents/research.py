...
class DeepResearchEngine:
    ...
    async def _synthesize_public_deep_dive(
        ...
        prompt = (
            ...
            "CRITICAL FORMATTING RULE: DO NOT act like a news reader. Do not list headlines. Synthesize the news into actionable intelligence.\n\n"
            "FORMAT:\n\n"
            ...
            "[Synthesize recent headlines into a 1-2 sentence intelligence summary. Do not just list headlines. If no recent news, state 'No breaking catalysts verified in the last 24h.']\n\n"
